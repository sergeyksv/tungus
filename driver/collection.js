...
TingoCollection.prototype.__proto__ = MongooseCollection.prototype;
...
TingoCollection.prototype.onClose = function(force) {
...
TingoCollection.prototype.$print = function(name, i, args) {
...
TingoCollection.prototype.$format = function(arg) {
  var type = typeof arg;
...
TingoCollection.prototype.getIndexes = () => { throw new Error('TingoDB does not support indexInformation()'); };
