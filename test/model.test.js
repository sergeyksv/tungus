...
describe('Model', function(){
  ...
  describe('#remove()', function(){
    ...
    it.skip('passes the removed document (gh-1419)', function(done){
  ...
  describe('getters', function(){
    ...
    describe('nested', function(){
      ...
      it.skip('array of Mixed on existing doc can be pushed to', function(done){
        var db = start();
      ...
      it.skip('props can be set directly when property was named "type"', function(done){
        var db = start();
  ...
  it.skip('doubly nested array saving and loading', function(done){
  ...
  it.skip('updating multiple Number $pushes as a single $pushAll', function(done){
    var db = start()
      , schema = new Schema({
          nested: {
            nums: [Number]
  ...
  it.skip('updating at least a single $push and $pushAll as a single $pushAll', function(done){
    var db = start()
      , schema = new Schema({
          nested: {
            nums: [Number]
  ...
  describe('saving embedded arrays', function(){
    it.skip('of Numbers atomically', function(done){
      var db = start()
    ...
    it.skip('of Strings atomically', function(done){
      var db = start()
    ...
    it.skip('of Buffers atomically', function(done){
      var db = start()
    ...
    it.skip('works with modified element properties + doc removal (gh-975)', function(done){
      var db = start()
  ...
  it.skip('removing a subdocument atomically', function(done){
    var db = start()
      , BlogPost = db.model('BlogPost', collection);
  ...
  it.skip('single pull embedded doc', function(done){
    var db = start()
    , BlogPost = db.model('BlogPost', collection);
  ...
  it.skip('saving mixed data', function(done){
    var db = start()
      , BlogPost = db.model('BlogPost', collection)
      , count = 3;
  ...
  describe('#exec()', function(){
    ...
    describe('promises', function(){
      ...
      it.skip('are thenable', function(done){
        var db = start()
          , B = db.model('BlogPost', collection)
  ...
  describe('profiling', function(){
    ...
    it.skip('level can be set', function(done){
      var db = start();
  ...
  describe.skip('auto_reconnect', function(){
  ...
  describe('_delta()', function(){
    it.skip('should overwrite arrays when directly set (gh-1126)', function(done){
      var db = start()
        , B = db.model('BlogPost', collection);
    ...
    it.skip('should use $set when subdoc changed before pulling (gh-1303)', function(done){
      var db = start()
  ...
  describe('backward compatibility', function(){
    it.skip('with conflicted data in db', function(done){
      var db = start();
