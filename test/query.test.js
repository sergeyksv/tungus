...
describe('Query', function(){
  ...
  describe('casting', function(){
    ...
    it.skip('find $ne should not cast single value to array for schematype of Array', function(done){
      var query = new Query();
      var db = start();
      var Product = db.model('Product');
    ...
    it.skip('find should not cast single value to array for schematype of Array', function(done){
      var query = new Query();
      var db = start();
      var Product = db.model('Product');
      var Comment = db.model('Comment');
  ...
  describe('without a callback', function(){
    it.skip('count, update, remove works', function(done){
      var db = start();
      var query = new Query();
  ...
  describe('options', function(){
    ...
    describe('tailable', function(){
      ...
      it.skip('supports passing the `await` option', function(done){
        var query = new Query();
